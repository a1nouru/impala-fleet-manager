...
// Function to check if Next.js cache might be corrupted
...
// Check for corrupted Next.js cache
if (isNextCacheCorrupted()) {
  console.log('⚠️ The Next.js cache directory appears to be in a bad state.');
